...
function run = SCION_initialise(runcontrol)
    ...
    pars.k_locb = 2.5e12 ;
    %pars.k_mocb = 2.5e12 ;
    pars.k_mocb_s = 0.8 * 2.5e12 ;
    pars.k_mocb_i = 0.2 * 2.5e12 ;  
    ...
    %%%% S cycle
    %pars.k_mpsb = 0.7e12 ;
    pars.k_mpsb_i = 0.2 * 0.7e12 ;
    pars.k_mpsb_s = 0.8 * 0.7e12 ;
    ...
    %%%% P cycle
    %pars.k_capb = 2e10 ;
    pars.k_capb_s = 0.8 * 2e10 ;
    pars.k_capb_i = 0.2 * 2e10 ;
    
    %pars.k_fepb = 1e10 ;
    pars.k_fepb_s = 0.8* 1e10 ;
    pars.k_fepb_i = 0.2* 1e10 ;
    
    %pars.k_mopb = 1e10 ;
    pars.k_mopb_s = 0.8* 1e10 ;
    pars.k_mopb_i = 0.2* 1e10 ;
    
    pars.k_phosw = 4.25e10 ;
    pars.k_landfrac = 0.0588 ;
    %%%% N cycle
    pars.k_nfix_s = 0.8 * 8.67e12 ;
    pars.k_nfix_i = 0.2 * 8.67e12 ;
%     pars.k_denit_s = 0.8 * 4.3e12 ;
%     pars.k_denit_i = 0.2 * 4.3e12 ;
    pars.k_denit_s = 0.8 * 8.6e12 ;
    pars.k_denit_i = 0.2 * 8.6e12 ;
    
    %%%% fluxes calculated for steady state
    pars.k_oxidw = pars.k_mocb_i + pars.k_mocb_s + pars.k_locb - pars.k_ocdeg - pars.k_reductant_input;
    ...
    pars.k_oxfrac_i = 0.9975 ;
    pars.k_oxfrac_s = 0.9975 ;
    Pconc0 = 2.2 ;
    Nconc0 = 30.9 ;
    pars.newp0_i = 117 * min(Nconc0/16,Pconc0) ;
    pars.newp0_s = 117 * min(Nconc0/16,Pconc0) ;
    ...
    %pars.P0 = 3.1*10^15 ;
%     pars.P0_s = 5.5E12; % Lewis Science 
%     pars.P0_i = 3.0945E15;
%   P0 = 3.1545e15
    pars.P0_s = (0.0045 / 3.2350) * 3.1e15;
    pars.P0_i = (3.2305 / 3.2350) * 3.1e15;
    
    %pars.N0 = 4.35e16 ;
%     pars.N0_i = 4.30*10^16; first change
%     pars.N0_s = 0.05*10^16;
    pars.N0_s = (0.0045 / 3.2350) * 4.35*10^16; %first change
    pars.N0_i = (3.2305 / 3.2350) * 4.35*10^16;
%     pars.N0_i = 4e16; %first change
%     pars.N0_s = 3.51e12;
    ...
    %%%%%%% Input the insolation forces into the SCION model here
    %  mode = 1 >> using the complete insolation signals as a force
    %  mode = 2 >> using the high envelop of  insolation signals (AM) as a force
    Insolation_mode = 1;
...
%     pars.whenend = 0 ;
    ...
    %pars.pstart = pars.P0;
    pars.P_s_start = pars.P0_s;
    pars.P_i_start = pars.P0_i;
    pars.N_s_start = pars.N0_s;
    pars.N_i_start = pars.N0_i;
    ...
    if isempty(Gtune) == 1
        ...
        outputs = [ 0.65 1 1.2 0.5 0.1 0.05 10] ;  % Scenario 1: 2.9 mM SO4， 8.3% O2 . epsilon = 0.5
        %outputs = [0.30 1 1.2 0.5 0.3 0.05 10] ; % Scemarop 4: 6.1 mM SO4,8.4% O2. epsilon = 0.5
        %outputs =  [1.55 1 1 1 1 0.05 10] ;       % %Scenario 2 : eplison = 1.5;  3mM, 18.4 % O2
        %outputs = [2 1 1.2 0.5 0.1 0.05 10];  % Scenario 3: 0.72 mM, 11%. . epsilon = 0.55
    ...
    %%%% model start state
    pars.startstate(1) = pars.P_i_start ;
    ...
    pars.startstate(11) = pars.N_i_start ;
    ...
    % this work
    pars.startstate(22) = pars.P_s_start ;
    pars.startstate(23) = pars.N_s_start ;
