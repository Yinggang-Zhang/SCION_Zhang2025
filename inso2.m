...
load 'insolation_and_temperature/latitude_inso_99_89.mat'
    ...
    if t_geol >=  -524.3 & t_geol <= -514.3
        ...
        for latitude_id = 1:1:40
            ...
            [highenv,] = envelope(inso_at_lati,10,'peak');
            ...
            ETP(latitude_id,1) = contribution_past .* highenv(1,key_past_index) + contribution_future .* highenv(1,key_future_index);
        end
    else
        ETP = zeros(40,1);
    end
